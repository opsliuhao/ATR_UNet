...
from dataset.two_dimension.dataset import BlockDataset, VolumeDataset
...
if __name__ == '__main__':
    ...
    required.add_argument('-out', '--out_dir', type=str, default="data/out_pspnet", help='Output Directory')
    required.add_argument('-modelType', '--model_type', type=str, default="PSP_Net", help='Model Type')
    # Optional Option
